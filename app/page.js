    ...
    <>
      ...
      <div className="container mt-5">
          <div className="d-block text-center mb-5">
            ...
            <a className="text-dark font-weight-bold" href="/category/lists">Browse all categories &#62;</a>
          </div>
          ...
          <div className="d-block text-center mb-5">
            <h3>Products</h3>
            <a className="text-dark font-weight-bold" href="/product/lists">Browse all products &#62;</a>
          </div>
        <div className="row">
